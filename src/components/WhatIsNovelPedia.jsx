  ...
  return (
    ...
    >
      <motion.h2
        ...
        variants={fadeUp}
      >
        {/* Change: Using a brighter violet for better contrast on large text */}
        What is <span className="font-bold"><span className="text-violet-300">Novel</span><span className="text-gray-100">Pedia</span></span>
      </motion.h2>

      <motion.blockquote
        // Change: Using a lighter gray for better readability on secondary text
        className="italic text-gray-400 text-lg text-center max-w-3xl mb-12"
        variants={fadeUp}
      >
      ...
      <motion.p
        // Change: Using a brighter gray for main body text
        className="text-lg text-center max-w-3xl mb-6 text-gray-100 border border-violet-600/50 bg-black/30 rounded-lg p-6 backdrop-blur-sm"
        variants={fadeUp}
      >
      ...
      <motion.p
        // Change: Using a brighter gray for main body text
        className="text-lg text-center max-w-3xl text-gray-100 border border-violet-600/50 bg-black/30 rounded-lg p-6 backdrop-blur-sm"
        variants={fadeUp}
      >
      ...
      <motion.h3
        // Change: Using a brighter violet for better contrast on large text
        className="font-bold mt-12 text-violet-200 text-3xl"
        style={{ textShadow: "0 0 10px #8b5cf6" }} // Glow effect helps with visibility too
        variants={fadeUp}
      >
        Welcome home.
      </motion.h3>
